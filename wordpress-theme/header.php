...
<header class="site-header">
  ...
  <a class="brand brand-image" href="<?php echo esc_url(home_url('/')); ?>" aria-label="Gravedad Store"><img class="brand-logo" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/logo-gravedad-store.webp'); ?>" alt="Gravedad Store" width="700" height="233" fetchpriority="high" decoding="async"></a>
  <?php endif; ?>
