...
<header class="site-header">
  ...
  <a class="brand brand-image" href="<?php echo esc_url(home_url('/')); ?>" aria-label="Gravedad Store"><img class="brand-logo" src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/logo-gravedad-store.png'); ?>" alt="Gravedad Store" width="1200" height="400" fetchpriority="high" decoding="async"></a>
  <?php endif; ?>
  <form class="header-search" id="header-search-form" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>" autocomplete="off"><span><?php echo gravedad_icon('search'); ?></span><input type="search" name="s" value="<?php echo esc_attr(get_search_query()); ?>" placeholder="Buscá cartas, juegos, colecciones..." autocomplete="off" aria-expanded="false" aria-controls="search-suggest"><input type="hidden" name="post_type" value="product"><div class="search-suggest" id="search-suggest" hidden></div></form>
