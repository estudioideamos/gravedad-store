<?php
/**
 * Resultados de búsqueda (contenido, sin cabecera ni pie): lo usan tanto
 * search.php como archive-product.php, que es la plantilla que WordPress
 * elige cuando la búsqueda trae post_type=product. Antes cada una tenía su
 * propia copia y se desincronizaban.
 */
