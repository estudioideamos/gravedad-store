...
<main class="singles-page">
  <header class="singles-hero has-image" style="--hero:url('<?php echo esc_url(get_template_directory_uri() . '/assets/img/hero-novedades.webp'); ?>')"><div class="singles-orbit"></div><div><nav class="hero-breadcrumb" aria-label="Breadcrumb"><a href="<?php echo esc_url(home_url('/')); ?>">Inicio</a> / Novedades</nav><p class="section-label"><i class="label-dash"></i>RECIÉN LLEGADOS</p><h1>Novedades.</h1><p>Los últimos ingresos a la tienda, primero.</p></div></header>
  ...
  <?php gravedad_active_filter_chips($filters); ?>
