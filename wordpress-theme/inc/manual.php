    ...
    return array(
        ...
        array(
            ...
            'items' => array(
                ...
                array('Atributos automáticos', 'Menú lateral → Editar Sitio → Atributos automáticos. Ahí armás "reglas": cada una dice "si el producto está en esta categoría, agregale estos atributos" (vacíos, listos para elegir el valor), así no hay que sumarlos a mano en cada producto. Se completan al guardar el producto (Publicar o Guardar borrador).'),
                array('Varias reglas a la vez', 'Con el botón "+ Agregar otra regla" podés sumar una regla por cada categoría que necesites (ej: una para "Cartas sueltas" con Colección/Idioma/Rareza/Condición/Juego, y otra distinta para "Juegos de mesa" con Editorial/Cantidad de jugadores). Si un producto está en varias categorías con regla propia, recibe la suma de los atributos de todas las que le apliquen. Cada regla se puede quitar con el botón "✕", o desactivar individualmente sin borrarla (tildado "Regla activa").'),
