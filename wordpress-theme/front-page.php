...
<section class="hero hero-slider-wrap<?php echo count($hero_slides) > 1 ? '' : ' hero-slider-single'; ?>">
  <div class="hero-slider-track">
    ...
    <?php $slide_bg = $slide['fondo'] ? $slide['fondo'] : $uri . '/assets/img/hero-gravedad.webp'; ?>
...
<section class="hero" style="--hero:url('<?php echo esc_url($hero['imagen']); ?>')">
  ...
  <div class="hero-video-overlay"></div><div class="hero-grid"></div>
  <div class="hero-copy">
    <span class="eyebrow"><i></i> <?php echo esc_html($hero['eyebrow']); ?></span>
    <h1><?php echo esc_html($hero['titulo_1']); ?><br><em><?php echo esc_html($hero['titulo_2']); ?></em></h1>
    <p><?php echo esc_html($hero['texto']); ?></p>
    <div>
      <a class="button primary" href="<?php echo esc_url($hero['boton1_url']); ?>"><?php echo esc_html($hero['boton1_texto']); ?> →</a>
      <a class="button ghost" href="<?php echo esc_url($hero['boton2_url']); ?>"><?php echo esc_html($hero['boton2_texto']); ?></a>
    </div>
  </div>
