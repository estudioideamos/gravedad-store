...
<section class="feature-categories">
 ...
 <a href="<?php echo esc_url(gravedad_shop_url('juegos-de-mesa')); ?>"><b><?php echo gravedad_icon('hexagon'); ?></b><div><small>PARA COMPARTIR LA MESA</small><h3>Juegos de mesa</h3><p>Estrategia, party games, cooperativos, familiares y mucho más.</p><strong>EXPLORAR →</strong></div></a>
</section>
